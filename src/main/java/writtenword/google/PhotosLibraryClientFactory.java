...
/**
 * A factory class that helps initialize a {@link PhotosLibraryClient} instance. Made by google copied from
 * https://github.com/google/java-photoslibrary/blob/master/sample/src/main/java/com/google/photos/library/sample/factories/PhotosLibraryClientFactory.java
 */
  ...
  private static Credentials getUserCredentials(String credentialsPath, List<String> selectedScopes)
    ...
    GoogleClientSecrets clientSecrets =
        GoogleClientSecrets.load(
            JSON_FACTORY, new InputStreamReader(PhotosLibraryClientFactory.class.getResourceAsStream(credentialsPath)));
